/*
IOS/安卓： 快手极速版-修复多账号版
5/12版本更新，重点修复了多账号无法使用的问题，内置最新的900+900金币广告json，脚本无需代理，可直接开跑。
13:00之前跑990金币+90金币（预计跑完5-6次后0金币）
...
let _0x134a17 = new Date(),
    ...
    _0x2e716e = 0,
    _0x5bc515 = "ksjsb",
    _0x180c0c = "http://210.116.112.17/zl",
    ksjsbjk = "http://210.116.112.17/990",
  ...
  if (p[_0x5bc515]) {
    ...
    if (a["status"] == 0) {
      if (_0x459e63 >= a["version"]) {
        _0x2e716e = true;
        _0x75eec0 = "http://210.116.112.17/zl";
